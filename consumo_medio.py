...
def preprocessar_dados(df_ext, df_int, df_val):
    ...
    df_val['VALOR'] = df_val['VALOR'].apply(converter_para_float)
...
def calcular_consumo_medio(df_ext, df_int):
    """Calcula o consumo médio (km/l) dos veículos"""
    ...
    return consumo_medio.sort_values('km_l', ascending=False)
...
def main():
    ...
    with tab3:
        ...
        consumo_medio = calcular_consumo_medio(df_ext, df_int)
