...
def main():
    ...
    # É crucial que esta conversão seja robusta para o filtro de data funcionar
    ...
    # Remove linhas com 'DATA' NaN após a conversão para garantir que o filtro funcione com datas válidas
    ...
    if periodo_selecionado == 'Intervalo Personalizado':
        data_selecao_manual = st.sidebar.date_input(
            ...
            value=(min_data_available, max_data_available),
        ...
        if len(data_selecao_manual) == 2:
            ...
            pass # Caso raro, mantém o intervalo já definido
    ...
    with tab1:
        # AQUI ESTÁ A MUDANÇA PARA O FORMATO BRASILEIRO (DD/MM/YYYY)
